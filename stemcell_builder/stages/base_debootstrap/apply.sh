...
# Install debootstrap
if is_ppc64le; then
  #wget "http://archive.ubuntu.com/ubuntu/pool/main/d/debootstrap/debootstrap_1.0.78_all.deb" -qO $downloaded_file
  wget "http://archive.ubuntu.com/ubuntu/pool/main/d/debootstrap/debootstrap_1.0.81ubuntu3.1_all.deb"  -qO $downloaded_file
#  && \
